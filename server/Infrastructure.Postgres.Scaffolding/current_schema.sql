...
CREATE TABLE crazyrobot.generated_report (
...
CREATE TABLE crazyrobot.user_guest (
    id text NOT NULL,
    email text NOT NULL,
    role text NOT NULL,
...
CREATE TABLE crazyrobot.survey_response (
    ...
    CONSTRAINT fk_response_user_guest FOREIGN KEY (user_id) REFERENCES crazyrobot.user_guest (id) ON DELETE CASCADE
);
...
CREATE INDEX ix_survey_response_user_guest_id ON crazyrobot.survey_response (user_id);
